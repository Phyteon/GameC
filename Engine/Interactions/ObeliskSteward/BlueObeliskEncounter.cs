...
namespace Game.Engine.Interactions
{
    ...
    [Serializable]
    class BlueObeliskEncounter : PlayerInteraction
    {
        private List<string> myColors;
        private StewardEncounter myself;
        public IObeliskStrategy Strategy { get; set; } // store strategy 
        public BlueObeliskEncounter(GameSession ses, List<string> myColors, StewardEncounter myself) : base(ses)
        {
            Name = "interaction0033";
            Strategy = new BlueObeliskNeutral(); // start with default strategy            
            this.myself = myself;

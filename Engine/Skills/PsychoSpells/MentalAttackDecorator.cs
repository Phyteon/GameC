...
namespace Game.Engine.Skills.BasicSkills
{
    ...
    class MentalAttackDecorator : SkillDecorator
    {
        ...
        public MentalAttackDecorator(Skill skill) : base("Mental Attack", 10, 1, skill)
        {
            ...
            PublicName = "COMBO - Mental Attack: 5 + 0.3 * MP damage[psycho] AND " + decoratedSkill.PublicName.Replace("COMBO: ", "");
        ...
        public override List<StatPackage> BattleMove(Player player)
        {
            ...
            response.CustomText = "You use Mental Attack! (" + (5 + (int)(0.3*player.MagicPower)) + " psycho damage)";

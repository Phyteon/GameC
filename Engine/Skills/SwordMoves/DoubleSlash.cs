...
namespace Game.Engine.Skills.UpgradedWeaponMoves
{
    ...
    class DoubleSlash:Skill
    {
        ...
        public override List<StatPackage> BattleMove(Player player)
        {
            ...
            response2.CustomText = "You use Double Sword Slash! (" + ((int)(0.2 * player.Strength) + (int)(0.2 * player.Precision)) + " cut damage, " + ((int)(0.2 * player.Strength) + (int)(0.2 * player.Precision)) + " incised damage)";

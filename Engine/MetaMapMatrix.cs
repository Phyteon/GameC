...
namespace Game.Engine
{
    ...
    class MetaMapMatrix
    {
        ...
        private const int interactions = 2; // approximate number of all interactions (including shops) in the game world (not strictly guaranteed due to quest constraints)

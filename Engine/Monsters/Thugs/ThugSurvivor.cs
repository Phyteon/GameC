    ...
    class ThugSurvivor:Monster
    {
        ...
        public override List<StatPackage> BattleMove()
        {
            if (Stamina >= 15)
            {
                ...
                new StatPackage(DmgType.Cut, 10 + Strength, "Thug uses his knife! (" + (10 + Strength) + " cut damage)"),
                new StatPackage(DmgType.Other, 30, "A thug beats you very furiously! (30 hit damage)")
                };
            }
            else
            {
